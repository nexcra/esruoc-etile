...
public class ColumnDao extends BaseDao<Column> {
	...
	public int addColumn(Column column) {
		...
		sql.append(" ( column_name, column_type ,column_content,description,order_num, show_on_nav, insert_time ,update_time ) ");
		sql.append(" values ");
		sql.append(" ( ?, ?, ?, ?, ? ,? ,now(),now()) ");
		Object[] values = { column.getColumnName(), column.getColumnType(),
				column.getColumnContent(), column.getDescription(),
				column.getOrderNum(), column.getShowOnNav() };
	...
	public Map getColumnById(String id) {
		StringBuilder sql = new StringBuilder();
		sql.append(" select id, column_name, column_type ,show_on_nav, show_on_index_page, column_content,description,order_num,insert_time ");
	...
	public List<Column> listAllColumnForArticle() {
		...
		StringBuilder sql = new StringBuilder();
		sql.append(" select t.id, t.column_name, t.column_type ");
		sql.append(" from t_column t ");
