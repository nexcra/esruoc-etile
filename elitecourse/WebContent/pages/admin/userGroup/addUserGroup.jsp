...
<body>
	<form
		action="${ctx }/admin/userGroup.do?action=addUserGroup"
		...
		<table width="100%" border="1" class="formTable">
			...
			<tr><td  class="fieldName"  width="20%">userId:</td>  <td  class="fieldForm"  width="80%"><select name="userId" id="userId"><option value="">请选择</option><c:forEach var="userList" items="${userList }"><option value="${userList.id }">${userList.name }</option></c:forEach></select><span  class="asterisk">*</span></td> </tr><tr><td  class="fieldName"  width="20%">groupId:</td>  <td  class="fieldForm"  width="80%"><select name="groupId" id="groupId"><option value="">请选择</option><c:forEach var="groupList" items="${groupList }"><option value="${groupList.id }">${groupList.name }</option></c:forEach></select><span  class="asterisk">*</span></td> </tr>
			<tr>
