...
<body>
	<form
		action="${ctx }/admin/assignmentClass.do?action=updateAssignmentClass"
		...
		<table width="100%" border="1" class="formTable">
			...
			<tr>
				...
				<td class="fieldForm" width="80%"><textarea name="description"
						id="description">${map.description }</textarea> <span class="asterisk">*</span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="fieldForm" width="80%"><input name="startTime"
					id="startTime"
					value="<fmt:formatDate value='${map.start_time }' pattern='yyyy-MM-dd HH:mm:ss'/>"
			...
			<tr>
				...
				<td class="fieldForm" width="80%"><input name="endTime"
					id="endTime"
					value="<fmt:formatDate value='${map.end_time }' pattern='yyyy-MM-dd HH:mm:ss'/>"
					type="text" class="inputText"
