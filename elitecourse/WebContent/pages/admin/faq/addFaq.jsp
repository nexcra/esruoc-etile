...
<body>
	<form action="${ctx }/admin/faq.do?action=addFaq" name="addForm"
		...
		<table width="100%" border="1" class="formTable">
			...
			<tr>
				...
				<td class="fieldForm" width="80%"><textarea name="question"
						cols="100" rows="3" id="question"></textarea><span class="asterisk">*</span></td>
			</tr>
			<tr>
				<td class="fieldName" width="20%">答案:</td>
				<td class="fieldForm" width="80%"><textarea name="answer"
						cols="100" rows="3" id="answer"></textarea><span class="asterisk">*</span></td>
			</tr>
			<tr>
				<td class="fieldName" width="20%">参考资料:</td>
				<td class="fieldForm" width="80%"><textarea name="reference"
						id="reference"></textarea><span class="asterisk">*</span></td>
			</tr>
			<tr>
