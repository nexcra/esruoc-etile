...
<body>
	<table width="100%" border="1" class="formTable">
		 <tr>              <td  class="fieldName"  width="20%">name:</td>                <td  class="fieldForm"  width="80%">${map.name  }</td>  </tr>  <tr>              <td  class="fieldName"  width="20%">order_number:</td>                <td  class="fieldForm"  width="80%">${map.order_number  }</td>  </tr>  <tr>              <td  class="fieldName"  width="20%">create_user_name:</td>                <td  class="fieldForm"  width="80%">${map.create_user_name  }</td>  </tr>  <tr>              <td  class="fieldName"  width="20%">create_time:</td>                <td  class="fieldForm"  width="80%"><fmt:formatDate value='${map.create_time }' pattern='yyyy-MM-dd HH:mm:ss'/></td>  </tr>  <tr>              <td  class="fieldName"  width="20%">remark:</td>                <td  class="fieldForm"  width="80%">${map.remark  }</td>  </tr> 
		<tr>
