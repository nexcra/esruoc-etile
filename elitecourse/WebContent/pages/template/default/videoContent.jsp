...
<script type="text/javascript" src="${ctx }/js/jquery.media.plugin.js"></script>
<script type="text/javascript">
	$(function() {
		displayTime("time");
		$('a.media').media();
			...
			<div class="rightSide">
				<div class="column_article_list">
					<div class="column_article_list">
						...
						<div class="article_title">${video.name }</div>
						<div class="article_other_info">
							<c:if test="${video.type ==1 }">本站原创</c:if>
							<c:if test="${video.type ==2 }">网络转载</c:if>
							更新时间:
							<fmt:formatDate value="${video.create_time }"
								pattern="yyyy-MM-dd hh:mm:ss" />
						</div>
						<div class="article_content" id="article_content"
							style="text-align: center;">
							<embed src="${ctx }/widget/CuPlayer/CuPlayerMiniV3_Black_S.swf"
								flashvars="&CuPlayerFile=${ctx }${video.path }&CuPlayerImage=${ctx }/widget/CuPlayer/Images/flashChangfa2.jpg&CuPlayerWidth=600&CuPlayerHeight=400&CuPlayerAutoPlay=false&CuPlayerAutoRepeat=true&CuPlayerShowControl=false&CuPlayerAutoHideControl=false&CuPlayerAutoHideTime=5&CuPlayerVolume=80&CuPlayerGetNext=false"
								quality="high" bgcolor="#000000" width="600" height="400"
								name="simplevideostreaming" align="middle"
