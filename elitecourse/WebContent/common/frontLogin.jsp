		...
		<table border="0" cellspacing="0" cellpadding="0" class="login_table">
			...
			<tr>
				...
				<td><input name="name" type="text" class="input_text" id="name" /><span
					class="hint" style="display: none">&nbsp;请输入身份证号</span></td>
			</tr>

			<tr>
				<td align="right">密&nbsp;&nbsp;码：</td>
				<td><input name="password" type="password" id="password"
					class="input_text" /><span class="hint" style="display: none">&nbsp;请输入密码</span></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" ><div class="bookingStep">
						<a target="_blank"
							href="${ctx }/student.do?action=toRegister"  style="font-weight:bold">&nbsp;马上注册 &gt;&gt;</a>
						<a target="_blank"
