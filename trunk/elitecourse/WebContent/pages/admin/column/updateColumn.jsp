...
<body>
	<form action="${ctx }/admin/column.do?action=updateColumn"
					...
					id="parentParams"><option value="@@@@0@@0"
						...
						<c:forEach var="columnList" items="${columnList }">
							<option
								...
								<c:if test="${columnList.id ==map.id }">
								 selected ='selected'
								</c:if>
								>
		...
		<tr>
				...
				<td class="fieldForm" width="80%"><input type="text"
					name="orderNumber" id="orderNumber" value="${map.order_number }"/><span class="asterisk">*</span></td>
			</tr>
			<tr>
