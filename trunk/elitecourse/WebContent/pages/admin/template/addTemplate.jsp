...
<body>
	<form action="${ctx }/admin/template.do?action=addTemplate"
		...
		<table width="100%" border="1" class="formTable">
			...
			<tr>
				...
				<td class="fieldForm" width="80%"><input type="text"
					name="templateName" id="templateName" /><span class="asterisk">*</span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="fieldForm" width="80%"><input type="text"
					name="fileName" id="fileName" /><span class="asterisk">*</span></td>
			</tr>
			<tr>
				<td class="fieldName" width="20%">templateCode:</td>
				<td class="fieldForm" width="80%"><input type="text"
					name="templateCode" id="templateCode" /><span class="asterisk">*</span></td>
			</tr>
			<tr>
				<td class="fieldName" width="20%">templateContent:</td>
				<td class="fieldForm" width="80%"><textarea
						name="templateContent" id="templateContent"></textarea><span
