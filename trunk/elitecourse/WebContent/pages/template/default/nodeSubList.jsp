		...
		<div class="mainContent">
			...
			<div class="rightSide">
				<div class="column_article_list">
					<c:forEach var="childNodeList" items="${childNodeList }" begin="0"
						end="0">
						<div class="column_name">
							<h2>${childNodeList.name }</h2>
						</div>
						<c:if test="${childNodeList.type == 'text' }">
							<div class="article_content" id="article_content">${childNodeList.content
								}</div>
						</c:if>
						<c:if test="${childNodeList.type == 'link' }">
							<iframe border="0" frameborder="0" framespacing="0"
								marginheight="0" marginwidth="0" noResize scrolling="auto"
								width="780" src="${childNodeList.link }" vspale="0"
